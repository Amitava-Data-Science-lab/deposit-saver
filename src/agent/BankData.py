...
from src.tools.FinancialTools import estimate_surplus
...
capacity_planner_agent = LlmAgent(
    model='gemini-2.5-flash',
    name='capacity_planner_agent',
    ...
    tools=[load_bank_statement, estimate_surplus],
)
